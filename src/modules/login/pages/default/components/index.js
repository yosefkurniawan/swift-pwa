                            ...
                            <CardContent className={styles.cardContent}>
                                <div className="col-sm-12 hidden-mobile">
                                    <div className={styles.headerSpan}>
                                        <Typography type="bold" variant="h1" className={styles.titleForm}>
                                    ...
                                    (!isOtp || desktop) && (
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div className={classNames(styles.spanLabel, 'hidden-mobile')}>
                                                <Typography variant="p" className={styles.subtitleForm}>
                ...
                <div className="col-xs-12 col-sm-5 col-md-5 col-lg-5 hidden-mobile">
                    <div className="row">
                        <div className="col-sm-12">
                            <div className={styles.headerSpan}>
                                <Typography style={{ color: '#fff' }} type="bold" variant="h1" letter="uppercase">
                                    {t('login:newCustomer')}
                                </Typography>
                            </div>
                        </div>
                        <div className="col-sm-12">
                            <Typography variant="p" style={{ fontSize: 14, color: '#fff' }}>
