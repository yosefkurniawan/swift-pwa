...
````
import Page from '@core/notification/pages/list';
export default Page;
````
...
````
import Core from '@core/notification/pages/list/core';
````
...
#### * for example you can copy content and change on `@core/notification/pages/list/components/index.js`
...
1. Skeleton `@core/notification/pages/list/components/Skeleton`