...
import { useProduct } from '@core_modules/cms/components/cms-renderer/magezon/MagezonProductList/helpers/productHelper';
...
const ProductContent = (props) => {
    ...
    const { handleAddtowishlist, handleClick, handleSetCompareList } = useProduct();
